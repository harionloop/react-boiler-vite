...
const FDatePicker: React.FC<TFDatePicker> = React.forwardRef(({ name, label, textFieldProps, inputFormat, readOnly, ...props }) => {
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <DatePicker {...config} renderInput={(params) => <TextField {...textFieldParams(params)} variant='standard' />} />
